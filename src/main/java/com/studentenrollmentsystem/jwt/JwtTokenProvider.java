...
public class JwtTokenProvider {
    ...
    //get authentication object (principal) from bearer token
    public Authentication getAuthentication(HttpServletRequest request) {

        String token = retrieveBearerToken(request);
    ...
    private String retrieveBearerToken(HttpServletRequest request) {
    ...
    //check expiration date of retrieved token
